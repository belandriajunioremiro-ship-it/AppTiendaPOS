          ...
          <div className="bg-card border border-border rounded-xl p-6 space-y-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input id="codigo_barra" value={codigoBarra} onChange={e => setCodigoBarra(e.target.value)} className="bg-background border-input focus:border-ring" />
              </div>
            </div>
          ...
          <div className="bg-card border border-border rounded-xl p-6 space-y-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="space-y-2">
                ...
                {errors.moneda_precio && <p className="text-xs text-destructive-foreground">{errors.moneda_precio}</p>}
              </div>
              ...
              <div className="space-y-2">
                ...
                {errors.unidad_id && <p className="text-xs text-destructive-foreground">{errors.unidad_id}</p>}
              </div>
